...
<%
    ...
    user= (Usuarios) ses.getAttribute("user");
    String Nombre;
    int nivel;
										...
										<div>
                                                                                    <form action="LibroControl" method="post">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="publicacion" value="" placeholder="2019-12-21" />
                                                                                            </div>     
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="categoria">
                                                                                                    ...
                                                                                                    <% for(Categorias c: CategoriaDao.listar()){ %>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                 <select name="editorial">
                                                                                                    ...
                                                                                                    <% for(Editoriales c: EditorialDao.listar()){ %>
