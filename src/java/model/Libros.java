...
public class Libros implements Serializable {
    ...
    public Libros(String isbn, String titulo, String descripcion, String nombre_autor, String publicacion, String fecha_registro, int codigo_categoria, String nit_editorial) {
        this.isbn = isbn;
        this.titulo = titulo;
